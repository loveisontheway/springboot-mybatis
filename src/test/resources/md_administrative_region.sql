...
CREATE TABLE `md_administrative_region` (
  ...
  `city_code` bigint(12) DEFAULT NULL COMMENT '市（地区、自治州、盟）代码',
  `city_name` varchar(128) DEFAULT NULL COMMENT '市（地区、自治州、盟）名称',
  `county_code` bigint(12) DEFAULT NULL COMMENT '县（市辖区、县级市、旗）代码',
  ...
  `province_code` bigint(12) NOT NULL COMMENT '省（自治区、直辖市、特别行政区）代码',
  ...
  `town_code` bigint(12) DEFAULT NULL COMMENT '乡、镇（街道办事处）代码',
  `town_name` varchar(128) DEFAULT NULL COMMENT '乡、镇（街道办事处）名称',
  `village_code` bigint(12) DEFAULT NULL COMMENT '村（居民委员会、村民委员会）代码',
